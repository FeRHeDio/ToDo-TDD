...
class LocationTests: XCTestCase {
    ...
    func test_Location_WhenOnlyOneHasCoordinate_AreNotEqual() {
        assertLocationNotEqualWith(firstName: "Foo", firstLongLat: (0.0, 0.1), secondName: "Foo", secondLongLat: nil)
    }
    ...
    func test_Performance() {
        self.measure {
            assertLocationNotEqualWith(firstName: "First", firstLongLat: (0.3,9.3), secondName: "Second", secondLongLat: (9.1,12.5))
        }
    }
